     ...
     <li><a href="mdenglu.aspx">管理员登录</a></li> 
      ...
      <tr>
          ...
          <td class="auto-style4">
              <asp:TextBox ID="Txtzh" runat="server" Height="25px" Width="195px" ForeColor="#999999" onfocus="this.value='';this.style.color='#000000'">用户名/电话号</asp:TextBox>
          </td>
      </tr>
      <tr>
          <td class="auto-style7">密码：</td>
          <td class="auto-style3">
              <asp:TextBox ID="Txtmima" runat="server" Height="23px" Width="197px" TextMode="Password"></asp:TextBox>
          </td>
      </tr>
      <tr>
      ...
      <tr>
          <td class="auto-style7"><a href="zhuce.aspx">新用户注册</a></td>
          <td class="auto-style3">
